...
def get_parser():
    ...
    parser.add_argument("--config-file", default="./configs/avsbench/swin/OV_AVSS_SwinB.yaml")
    parser.add_argument("--model_input", default="./pre_models/")
    parser.add_argument("--audio_input", default="./datasets/AVSBench-semantic/")
    parser.add_argument("--output", default="./output_ov_avss_swinb/result/")
        ...
        for video_n, batch_data in enumerate(test_dataloader):
            ...
            for image_n in range(0, len(imgs_pth), num_frames):
                ...
                with autocast():
                    ...
                    save_pth = os.path.join(args.output, f.split(".")[0], video_name[0])
